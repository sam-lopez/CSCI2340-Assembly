...
#####################################################
# Function: PromptFloat - prints a floating number
# Parameters:
# $a0 - prompt string to print
# Returns
# $f0 - returns input float
######################################################
.text
PromptFloat:
# print prompt string
	li $v0, 4
	syscall
# load $v0 with value for reading float
	li $v0, 6
	syscall
	# move input saved to return value $f0
jr $ra
